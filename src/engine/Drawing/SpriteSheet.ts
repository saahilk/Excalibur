...
export class SpriteSheetImpl {
   ...
   */
  constructor(
    imageOrConfigOrSprites: Texture | ISpriteSheetArgs | ManagedSprite[],
    columns?: number,
    rows?: number,
    spWidth?: number,
    spHeight?: number,
  ...
  public getAnimationByIndices(engine: Engine, indices: number[], speed: number) {
    var images: ManagedSprite[] = indices.map((index) => {
   ...
   */
  public getSprite(index: number): ManagedSprite {
...
export class SpriteSheet extends Configurable(SpriteSheetImpl) {
  ...
  constructor(sprites: ManagedSprite[]);
...
export class SpriteFontImpl extends SpriteSheet {
   ...
   */
  public getTextSprites(): { [key: string]: ManagedSprite } {
    var lookup: { [key: string]: ManagedSprite } = {};

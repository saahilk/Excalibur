...
export class Resource<T> extends Class implements Loadable {
  ...
  private _loadResourcePromise: Promise<T>;
  ...
  private _loadResource(): Promise<T> {
  ...
  public load(): Promise<T> {
    if (!this._loadResourcePromise) {
      this._loadResourcePromise = this._loadResource();
    }
    return this._loadResourcePromise;
  }
